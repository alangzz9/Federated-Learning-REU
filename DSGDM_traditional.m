function [Opt_grad, Opt_concensus, Obj, Oracle] = DSGDM_traditional(stepsize,PW,  y_temp, iter_num, A, n, N, gc,fc, lambda, aalpha, momentum_coeff, features, labels,  bs, minibatch)
...
%         momentum(:,ii) = momentum_coeff * momentum(:,ii) + grad(:,ii);
    end
